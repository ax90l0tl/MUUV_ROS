...
Pid_node::Pid_node() : rclcpp::Node("pid_node")
{
    ...
    ctrl_effort_pub_ = this->create_publisher<muuv_msgs::msg::AllocatorCommand>(this->get_parameter("ctrl_effort_topic").as_string(), 1);
...
void Pid_node::pid_callback()
{
    ...
    if (new_state_or_setpt_)
    {
        ...
        auto output = muuv_msgs::msg::AllocatorCommand();
