...
public:
        ...
        : Node("pid_recombiner")
    {
        ...
        sub_x.subscribe(this, "ctrl_effort_x", custom_qos_profile);
        sub_y.subscribe(this, "ctrl_effort_y", custom_qos_profile);
        sub_z.subscribe(this, "ctrl_effort_z", custom_qos_profile);
        sub_rx.subscribe(this, "ctrl_effort_rx", custom_qos_profile);
        sub_ry.subscribe(this, "ctrl_effort_ry", custom_qos_profile);
        sub_rz.subscribe(this, "ctrl_effort_rz", custom_qos_profile);
